...
function prepareForSlot(Component) {
  return React14.forwardRef(function Slot(props, ref) {
    const other = _objectWithoutPropertiesLoose(props, _excluded2);
    return React14.createElement(Component, _extends({}, other, {
      ref
    }));
  });
}
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(React18.Fragment, {
...
var Portal = React38.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime13.jsx)(React38.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime13.jsx)(React38.Fragment, {
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React47.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(React52.Fragment, {
...
function useSelect(props) {
  ...
  const contextValue = React60.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime28.jsx)(React62.Fragment, {
...
var Select = React62.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React62.Fragment, {
...
function useSlider(parameters) {
  ...
  const sliderRef = React63.useRef();
  ...
  const previousIndex = React63.useRef();
...
var Slider = React64.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime31.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime30.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime30.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime31.jsxs)(React64.Fragment, {
...
function useTabsList(parameters) {
  ...
  const contextValue = React77.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var TextareaAutosize = React82.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime46.jsxs)(React82.Fragment, {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React85.useRef(false);
  const firstFocus = React85.useRef(true);
  const inputRef = React85.useRef(null);
  const listboxRef = React85.useRef(null);
  const [anchorEl, setAnchorEl] = React85.useState(null);
  const [focusedTag, setFocusedTag] = React85.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React85.useRef(defaultHighlighted);
  ...
  const resetInputValue = React85.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React85.useState(true);
  ...
  const syncHighlightedIndex = React85.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React85.useRef(false);
